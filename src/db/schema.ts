...
export const insuranceCompaniesTable = pgTable("insurance_companies", {
	...
	yearlyPriceInCents: integer("yearly_price_in_cents"),
	twoYearlyPriceInCents: integer("two_yearly_price_in_cents"),
	...
	topReasons: text("top_reasons").array(),
	rightOfWithdrawal: text("right_of_withdrawal"),
